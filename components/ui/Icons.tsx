...
/** Marca do Pix: o losango vazado. Preenchido, como o original. */
export const IconPix = ({ size = 20, ...rest }: IconProps) => (
  <svg
    width={size}
    height={size}
    viewBox="0 0 24 24"
    ...
    {...rest}
  >
    <path d="M12 1.8 8.9 4.9a4.4 4.4 0 0 1 6.2 0L12 1.8Zm-4.2 4.2L4.9 9.1a4.4 4.4 0 0 0 0 6.2l2.9 2.9a3 3 0 0 1 0-4.2l-1.7-1.7a1.7 1.7 0 0 1 0-2.4l1.7-1.7v-2Zm8.4 0v2l1.7 1.7a1.7 1.7 0 0 1 0 2.4l-1.7 1.7a3 3 0 0 1 0 4.2l2.9-2.9a4.4 4.4 0 0 0 0-6.2L16.2 6Zm-4.2 2.3L9.4 10.9a1.6 1.6 0 0 0 0 2.2l2.6 2.6 2.6-2.6a1.6 1.6 0 0 0 0-2.2L12 8.3ZM8.9 19.1 12 22.2l3.1-3.1a4.4 4.4 0 0 1-6.2 0Z" />
  </svg>
);
