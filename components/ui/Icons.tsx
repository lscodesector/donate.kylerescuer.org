...
/** Seta que sai da caixa - link que abre outro site, em aba nova. */
...
/** Tela com pé - "finalize no app ou site do seu banco". */
...
/** Os três alvos e o miolo de um QR Code - cabeça do bloco do QR. */
