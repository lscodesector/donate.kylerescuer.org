  ...
  return (
    ...
    >
      ...
      >
        ...
        <p className="mt-4 text-[14px] leading-[1.55] text-ink-600">
          Com um valor fixo todo mês, os abrigos conseguem comprar ração em
          quantidade em vez de esperar a próxima campanha.
        </p>
          ...
          {donationAmounts.map((amount) => {
            ...
            return (
              ...
              >
                ...
                <span className="block text-[10px] font-semibold text-ink-600">/mês</span>
              </button>
            );
          })}
        </div>
