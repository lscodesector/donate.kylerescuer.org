...
const copyComoFunciona = {
  ...
  steps: [
    ...
    {
      icon: "heart",
      title: "SOS Animal Help takes the help to the shelter",
      text: "The donation turns into food, medicine and vet care at the shelters Kyle follows - and SOS Animal Help publishes the receipts in the app.",
    },
  ],
};
