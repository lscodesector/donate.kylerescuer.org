...
const copyAbrigos = {
  ...
  ctaShelterMensal: "Make a difference",
...
const shelters: Shelter[] = [
  {
    ...
    description:
      "53 rescued dogs. Receives monthly support from Kyle for food, medicine and veterinary surgeries.",
    ...
    profile: {
      ...
      since: "",
      about:
        "Receives monthly support from Kyle for food, medicine and veterinary surgeries.",
    },
    cnpjDoc: {
  ...
  },
  {
    ...
    description:
      "92 animals. In May it nearly closed over unpaid rent. It is still open thanks to monthly donations.",
    ...
    profile: {
      ...
      since: "",
      about:
        "In May 2026 it nearly closed over unpaid rent. Kyle negotiated a 30-day extension, and it is still open thanks to monthly donations.",
    },
    cnpjDoc: {
  ...
  },
  {
    ...
    profile: {
      ...
      since: "",
      about:
        "Its facilities are in critical shape, kept going by voluntary donations for food and vet care.",
    },
    cnpjDoc: {
          ...
          >
            ...
            <div className="flex flex-1 flex-col items-center gap-3 p-4 text-center sm:items-start sm:p-5 sm:text-left">
              <div className="flex flex-col gap-1">
                ...
                {/* A linha de localização saiu do card (pedido de 04/09/2026):
                    ...
                    mostre, para não perder a informação de quem recebe. */}
