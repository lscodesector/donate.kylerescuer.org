...
function ShareButton({ className }: { className?: string }) {
  ...
  const compartilhar = async () => {
    ...
    const texto =
      "O Caio leva veterinário, exames e medicação a mais de 500 animais em cinco abrigos. Muitos estão em estado grave, esperando socorro. Dá uma olhada:";
