...
function ShareButton({ className }: { className?: string }) {
  ...
  const compartilhar = async () => {
    ...
    const texto =
      "Kyle brings vet care, tests and medication to more than 500 animals across five shelters. Many are in critical condition, waiting for help. Take a look:";
...
const NAV = [
  ...
  { href: "#duvidas", label: "Questions", icon: IconQuestion },
            ...
            */}
            ...
            <div className="flex shrink-0 flex-col gap-2 border-t border-ink-900/10 px-4 pb-[max(1rem,env(safe-area-inset-bottom))] pt-3">
              ...
              <p className="pt-1 text-fs12 leading-[1.4] text-ink-600">
                ...
                <br />
                Emergency help for those who have no voice.
              </p>
            </div>
          </nav>
        </>
