 ...
 *
 *   +500 vidas    é o número que a campanha publica ("500+ animais dependem
 ...
 * cuida do resto da página), e o que o Google lê é "500", não "0". Quem tem
 ...
 *
 * `prefix` e `suffix` ficam fora da conta de propósito: o "+" de "+500" e o
