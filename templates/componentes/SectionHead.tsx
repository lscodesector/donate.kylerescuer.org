/**
 * ╔══════════════════════════════════════════════════════════════════════╗
 * ║  TEMPLATE · SectionHead - a cabeça de toda seção                      ║
 * ╚══════════════════════════════════════════════════════════════════════╝
 *
 * Eyebrow (linha curta em maiúsculas), título e linha de apoio.
 *
 * ── O padrão é sem ícone e centralizado ───────────────────────────────────
 ...
 *
 * `icon` e `align` existem para a exceção - hoje, uma seção em toda a página.
 * Antes de usar em outra, vale lembrar que cada uso é uma cabeça a menos
 * alinhada com o resto.
 *
 * O conteúdo *abaixo* da cabeça continua livre para alinhar como fizer
 * sentido - e a maioria alinha à esquerda a partir de `sm`.
 *
 * ── Como usar ─────────────────────────────────────────────────────────────
 *   <SectionHead eyebrow="Transparência" title="Para onde vai o dinheiro"
 *                lead="A conta que os abrigos fecham todo mês." />
 *
 * ── A medida do título ────────────────────────────────────────────────────
 * `clamp(1.279rem, 0.977rem + 1.209vw, 1.976rem)` - escrita por extenso e não
 * como degrau nomeado porque é a medida de título de seção da rede inteira.
 * Use este componente e você não precisa lembrar dela.
 *
 * Depende de `Reveal` (mesmo template).
 */
